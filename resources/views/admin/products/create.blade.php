    ...
    <ul class="list-group row">
      ...
      <li class="list-group-item">
        ...
        <div class="img-thumbnail  text-center">
              <img width="100"  src="@if(isset($product)) {{asset('images/'.$product->product_image)}} @else {{asset('images/no-product_image.jpeg')}} @endif" id="imgproduct_image" class="img-fluid" alt="">        
